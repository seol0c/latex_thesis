...
\makeatletter\def\Hy@Warning#1{}\makeatother % 하이퍼링크 경고 삭제
...
% bul
\newcommand{\bul}[1][1em]{\par\makebox[#1][r]{\raisebox{0.25ex}{\scalebox{0.5}{$\bullet$}}\,\,}\hangindent=#1 \hangafter=1\relax}
