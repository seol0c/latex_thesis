...
\newcommand{\rulerpencilnotag}{
  \par\vspace*{10pt}
  \begingroup\centering
    \includegraphics[scale=0.24]{../tablefigure/figures/rulerpencil}
    \par\endgroup}
...
\vspace*{-8pt}
\includegraphics[scale=0.24]{../tablefigure/figures/caliperpencil}
\label{fig:caliperpencil}\vspace*{0pt}\end{figure}}

\newcommand{\caliperpencilnotg}{%
  \par\vspace*{10pt}%
  \begingroup\centering
    \includegraphics[scale=0.24]{../tablefigure/figures/caliperpencil}%
    \par\endgroup}
